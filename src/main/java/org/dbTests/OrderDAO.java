...
public class OrderDAO extends DataAccessObject<Order> {
    ...
    private final static String GET_FOR_CUS = "SELECT * FROM get_orders_by_customer(?)";
    ...
    public List<Order> getOrdersForCustomer(long customerId){
        ...
        try(PreparedStatement statement = this.connection.prepareStatement(GET_FOR_CUS);){
