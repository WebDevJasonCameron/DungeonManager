...
public class Manager {
    ...
    private String location;            //   Physical location of the dungeon management office or headquarters
    ...
    // LISTs
    private List<Skill> skills;         //   List any unique skills, magical abilities, or attributes
